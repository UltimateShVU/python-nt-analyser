...
# Simple DoS-attack detection
def dos_detection(packet_queue, result_dict):
    time_connections = []
    danger_adresses = {}
    last_time = 0
        ...
        if not packet_queue.empty():
            ...
            if packet:
                ...
                if packet['proto'] == 'TCP':
                    ...
                    if __check_tcp_traffic(payload):
                        result_dict["TCP traffic"] = f"TCP traffic is invalid. This traffic was sent from: {src}"
